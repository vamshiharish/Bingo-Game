...
# def mark_computer_values(com_bin,bin_val):
...
#             list_a.append(value)
#         person_bingo.append(list_a)  
#     return person_bingo      
    

# def computer_bingo(N,range_list):
#     computer_bingo = []
#     for i in range(N):
#         list_a = []
#         for j in range(N):
#             random_number = random.choice(range_list)
#             list_a.append(random_number)
#             range_list.remove(random_number)
#         computer_bingo.append(list_a)
#     return computer_bingo   
...
# range_list = list(range(1,N**2+1))

# com_bin = computer_bingo(N,range_list)

# person_bin = person_bingo(N)

# not_repeat_value = []

# for i in range(N):
#     for j in range(N):
#         bin_val = int(input(f"enter the value to make bingo 1 to {N**2}:"))
#         if bin_val not in not_repeat_value:
#             not_repeat_value.append(bin_val)
#             A = mark_computer_values(com_bin,bin_val)
#             com_bin = A
#             print(com_bin)
            
#             B = mark_computer_values(person_bin,bin_val)
#             person_bin = B
#             print(person_bin)
#             check = check_bingo(com_bin)
#         else:
#             print("please dont enter repeated numbers")    
